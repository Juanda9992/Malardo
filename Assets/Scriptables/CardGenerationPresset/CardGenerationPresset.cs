...
public class CardGenerationPresset : ScriptableObject
{
    ...
    public void AddCustomCard()
    {
        ...
        {
            allCards.Add(new Card(){number = presetCard.number, cardSuit = presetCard.cardSuit, cardType = presetCard.cardType,cardEdition = presetCard.cardEdition,cardSeal = presetCard.cardSeal});
        }
